...
const Footer = () => {
  const handleLinkedInClick = () => {
    window.open('https://sorry-sepia-beta.vercel.app/axtrioai', '_blank');
  };
  const handleGithubClick = () => {
    window.open('https://github.com/axtrioai', '_blank');
  };
  const handleEmailClick = () => {
    window.open('https://mail.google.com/mail/?view=cm&fs=1&to=contact@axtrioai.com', '_blank');
  };
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 mb-6 md:mb-0">
            <p className="text-gray-400 text-sm">
              © 2026 Axtrio AI. All rights reserved.
            </p>
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center">
                <img src="/og-logo.png" alt="Axtrio AI Logo" className="w-8 h-8 object-contain" />
              </div>
              <span className="text-white font-semibold">Axtrio AI</span>
            </div>
